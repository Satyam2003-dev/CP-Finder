/* PrismJS 1.26.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+brightscript+c+csharp+cpp+dart+go+java+kotlin+markup-templating+pascal+perl+php+python+r+ruby+rust+scala+swift+typescript&plugins=line-highlight+line-numbers+show-language+toolbar+copy-to-clipboard */
var _self =
